...
Decay_H = Decay(name = 'Decay_H',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-12*MB**2*yb**2 + 3*MH**2*yb**2)*cmath.sqrt(-4*MB**2*MH**2 + MH**4))/(16.*cmath.pi*abs(MH)**3)',
                                  ...
                                  (P.H2,P.H3):'(gHHH**2*cmath.sqrt(MH**4 - 2*MH**2*MH2**2 + MH2**4 - 2*MH**2*MH3**2 - 2*MH2**2*MH3**2 + MH3**4))/(16.*cmath.pi*abs(MH)**3)',
...
Decay_H2 = Decay(name = 'Decay_H2',
                 particle = P.H2,
                 partial_widths = {(P.H,P.H):'(gH2H1**2*cmath.sqrt(-4*MH**2*MH2**2 + MH2**4))/(8.*cmath.pi*abs(MH2)**3)',
                                   (P.H,P.H3):'(gHHH**2*cmath.sqrt(MH**4 - 2*MH**2*MH2**2 + MH2**4 - 2*MH**2*MH3**2 - 2*MH2**2*MH3**2 + MH3**4))/(16.*cmath.pi*abs(MH2)**3)'})

Decay_H3 = Decay(name = 'Decay_H3',
                 particle = P.H3,
                 partial_widths = {(P.g,P.g):'(GH**2*gH3**2*MH3**6)/(8.*cmath.pi*abs(MH3)**3)',
                                   (P.H,P.H2):'(gHHH**2*cmath.sqrt(MH**4 - 2*MH**2*MH2**2 + MH2**4 - 2*MH**2*MH3**2 - 2*MH2**2*MH3**2 + MH3**4))/(16.*cmath.pi*abs(MH3)**3)'})
